...
# testing content of build-essentials. Remarrked line below is complete list of speecific dependencies. Note: didn't work.
apt-get -y install pkg-config gcc gtk+-2.0 glib-2.0 libgnome-2.0 libgnomeui-dev intltool itstool streamripper audacious
